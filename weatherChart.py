...
graph_it= Button(root, text= "Graph Weather Chart", compound = CENTER, command = graph)
...
sunButton = Button(root,text = 'Sunny', compound=TOP, image= sun_btn, command=sunClick)
sunButton['font']=myFont
sunButton.pack(side=LEFT,padx=20)

cloudyButton = Button(root,text = 'Cloudy', compound=TOP, image= cloudy_btn, command=cloudyClick)
cloudyButton['font']=myFont
cloudyButton.pack(side=LEFT,padx=20)

foggyButton = Button(root,text = 'Foggy',compound=TOP, image= foggy_btn, command=foggyClick)
foggyButton['font']=myFont
foggyButton.pack(side=LEFT,padx=20)

rainyButton = Button(root, text = 'Rainy',compound=TOP, image= rainy_btn,command=rainClick)
rainyButton['font']=myFont
rainyButton.pack(side=LEFT, padx=20)

windyButton = Button(root,text = 'Windy',compound=TOP, image= windy_btn, command=windyClick)
windyButton['font']=myFont
windyButton.pack(side= LEFT,padx=20)

snowyButton = Button(root,text = 'Snowy',compound=TOP, image= snowy_btn, command=snowyClick)
